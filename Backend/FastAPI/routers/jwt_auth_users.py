...
# Encritpadas las contraseñas Bcrypt
users_db = {
    "gustavors1": {
        "username": "gustavors1",
        "full_name": "Gustavo Rivera",
        "email": "gustavo@rivera.com",
        "disabled": False,
        "password": "$2a$12$B2Gq.Dps1WYf2t57eiIKjO4DXC3IUMUXISJF62bSRiFfqMdOI2Xa6"
    },
    "gustavors2": {
        "username": "gustavors2",
        "full_name": "Gustavo Rivera 2",
        "email": "gustavir@rivera2.com",
        "disabled": True,
...
async def login(form: OAuth2PasswordRequestForm = Depends()):
    ...
    access_token = {"sub": user.username,
                    ...
                    # Tiempo y Fecha para desconexión 
